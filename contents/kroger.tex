...
%
    ...
    \hspace{1.0em}
        {\textbf{Technologies:} Java 13, Spring Boot, Spring Data JPA, REST, microservices, SQL, SQL Server, SQL Developer, JUnit, Mockito,
            Git, Bash, shell scripting, Intellij, Scrum}
