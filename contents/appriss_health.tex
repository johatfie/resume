...
%
    ...
    \begin{itemize*}
        \item Software Engineer on the Blue team providing enhancements, bug fixes, and testing for several RESTful microservices (REST API).
    ...
    \hspace{1.0em}
        ...
        REST API, microservices, Kubernetes, JUnit, Mockito, ECMAScript 2018, Jest, Intellij, Git, Scrum}
    \fi
