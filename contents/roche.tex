...
%
    ...
    \hspace{1.0em}
        {\textbf{Technologies:} Java 17, Spring Boot, AWS, microservices, JSON, REST Api, Spring AOP, GraphQL, FHIR, Camunda 7, Postman, Sonarqube, Git, JUnit, Mockito, Intellij, Scrum}
