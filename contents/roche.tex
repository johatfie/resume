...
%
    ...
    \hspace{1.0em}
        {\textbf{Technologies:} Java 17, Spring Boot, AWS, microservices, Spring AOP, GraphQL, FHIR, Camunda 7, Postman, Sonarqube, Kubernetes, Linux, Git, JUnit, Mockito, Intellij, Scrum, Bash, shell scripting}
